...
export const getDailyPuzzle = (wordLength: 4 | 5 | 6 = 4): Puzzle => {
  ...
  const puzzlesByLength = {
    ...
    5: [
      ...
      { start: "STORM", goal: "CALM", minDist: 5 },
      ...
      { start: "STOUT", goal: "SLENDER", minDist: 7 },
      ...
      { start: "FROST", goal: "THAW", minDist: 5 },
      { start: "METAL", goal: "WOOD", minDist: 5 },
    ...
    6: [
      ...
      { start: "GRAVEL", goal: "PAVEMENT", minDist: 8 },
      { start: "SAILOR", goal: "PIRATE", minDist: 6 },
      { start: "DRAGON", goal: "WYVERN", minDist: 7 },
      { start: "THRONE", goal: "SCEPTER", minDist: 7 },
      { start: "CANYON", goal: "VALLEY", minDist: 6 },
      { start: "MARBLE", goal: "GRANITE", minDist: 7 },
      { start: "MASTER", goal: "NOVICE", minDist: 7 },
      { start: "SHIELD", goal: "BUCKLER", minDist: 7 },
      { start: "PLANET", goal: "ASTEROID", minDist: 8 },
      { start: "BASKET", goal: "CRATE", minDist: 6 },
      { start: "PORTAL", goal: "GATEWAY", minDist: 7 },
      ...
      { start: "CITRUS", goal: "MELON", minDist: 6 },
      { start: "BRONZE", goal: "SILVER", minDist: 6 },
      { start: "FABRIC", goal: "LEATHER", minDist: 7 },
      ...
      { start: "PUPPET", goal: "MARIONETTE", minDist: 8 },
    ],
  };
